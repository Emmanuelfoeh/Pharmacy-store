...
const Home = () => {
    ...
    <main className={classes.home}>
          ...
          <div className={classes.intro_section_text}>
            ...
            <div>
              ...
              <Typography fontSize="0.8rem" width="80%">
                Purchase medication from legitimate websites online. Search for
                a site to see if it is safe or not recommended. Join 8,405 of
                happy customers from the USA who give us a 99% satisfaction
                rate. They talk about
              </Typography>
              <Button
      ...
      <section className={classes.medicine}>
        <div className={classes.medicine_container}>
      ...
      <section className={classes.about}>
        <div className={classes.about__container}>
          ...
          <h5 className={classes.about__text__heading}>ABOUT US</h5>
          <h2 className={classes.about__text__header}>
            THE FUTURE OF PHARMACY
          </h2>
          <article className={classes.about__text__article}>
            Far far away, behind the word mountains, far from the countries
          ...
          <button className={classes.about__text__btn}>More about us</button>
        </div>
        <div className={classes.aboutImage}>
          {/* <div className={classes.bigBall}></div> */}
          <div>
            <img
              className={classes.aboutImg1}
              src="\img\pharmacy-imgabout1.jpg"
              alt="aboutimage1"
            />
          </div>
          ...
          <div>
            <img
              className={classes.aboutImg2}
              src="\img\pharmacy-imgabout2.jpg"
              alt="aboutimage2"
            />
          </div>
        </div>
